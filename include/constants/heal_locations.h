...
enum {
    ...
    HEAL_LOCATION_TESTMAPA,
    HEAL_LOCATION_FORESTS_EDGE,
    HEAL_LOCATION_NEW_HOPE,
    HEAL_LOCATION_PORT_VALOR,
    HEAL_LOCATION_ROUTE26,
    HEAL_LOCATION_DARK_FALLS,
    HEAL_LOCATION_STARLIGHT_GROVE,
    NUM_HEAL_LOCATIONS
};
